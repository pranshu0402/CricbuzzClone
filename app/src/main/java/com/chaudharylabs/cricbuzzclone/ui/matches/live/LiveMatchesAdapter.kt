...
import com.chaudharylabs.cricbuzzclone.databinding.LytLiveMatchItemsBinding
...
class LiveMatchesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding: LytLiveMatchItemsBinding =
            DataBindingUtil.inflate(inflater, R.layout.lyt_live_match_items, parent, false)
    ...
    inner class ViewHolder(var binding: LytLiveMatchItemsBinding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bind(match: Matche) {
            binding.apply {

                this.presenter = liveMatchesFragment

...
import com.chaudharylabs.cricbuzzclone.databinding.LytRecentMatchItemsBinding
...
class RecentMatchesAdapter(
...
) : RecyclerView.Adapter<RecentMatchesAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val binding: LytRecentMatchItemsBinding =
            DataBindingUtil.inflate(inflater, R.layout.lyt_recent_match_items, parent, false)
    ...
    inner class ViewHolder(var binding: LytRecentMatchItemsBinding) :
